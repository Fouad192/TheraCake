    ...
    useEffect(() => {
        if (props.apartmentAddressData[apartmentLastIndex]) {
            let initialApartmentAddressDetails = {
                firstName:
                    props.apartmentAddressData[apartmentLastIndex].firstName,
                lastName:
                    props.apartmentAddressData[apartmentLastIndex].lastName,
                ...
                building:
                    props.apartmentAddressData[apartmentLastIndex].building,
                floor: props.apartmentAddressData[apartmentLastIndex].floor,
                apartment:
                    props.apartmentAddressData[apartmentLastIndex].apartment,
                instructions: "",
                scheduled: "",
            };
        ...
        if (props.companyAddressData[companyLastIndex]) {
            let initialCompanyAddressDetails = {
                ...
                governorate:
                    props.companyAddressData[companyLastIndex].governorate,
                ...
                <div className={classes.informationContainer}>
                    ...
                    <div className={classes.apartmentContainer}>
                      ...
                      /> */}
                                        ...
                                        <button id={classes.apartmentSubmitBtn}>
                                            Place Order
                                        </button>
                                    </form>
                                </div>
                    ...
                    <div className={classes.villaContainer}>
                        <button onClick={villaDetailsHandler}>
                            Villa/House Details
                        </button>
                        {villaDetails && (
                            <div className={classes.villaDetails}>
                                <div className={classes.personalDetailsForm}>
                                    ...
                                    <form onSubmit={villaSubmitHandler}>
                                        ...
                                        <button id={classes.villaSubmitBtn}>
                                            Place Order
                                        </button>
                                    </form>
                                </div>
                    ...
                    <div className={classes.workplaceContainer}>
                        <button onClick={workplaceDetailsHandler}>
                            Workplace details
                        </button>
                        {workplaceDetails && (
                      ...
                      /> */}
                                        ...
                                        <button id={classes.workplaceSubmitBtn}>
                                            Place Order
                                        </button>
                                    </form>
                                </div>
                ...
                <div className={classes.invoiceContainer}>
                    ...
                    {props.addedItems.length != 0 && (
                        <>
                            ...
                            <Link href="/menu">
                                <button className={classes.addMoreItems}>
                                    Add More Items
                                </button>
                            </Link>
                        </>
